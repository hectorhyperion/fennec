            ...
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img src="<?php echo base_url('/assets/images/4.png')?>" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="<?php echo base_url('/assets/images/5.png')?>" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="<?php echo base_url('/assets/images/pic1.png')?>" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="<?php echo base_url('/assets/images/2.png')?>"><span class="badge">9</span></a>
	        		<ul class="dropdown-menu">
						...
						<li class="m_2"><a href="<?php echo site_url('index/logout')?>"><i class="fa fa-lock"></i> Logout</a></li>	
	        		</ul>
	      		</li>
			</ul>
